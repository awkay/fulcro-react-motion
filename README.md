...
`src/main/transitions/client.cljs` contains the code to start and refresh
...
application `transitions.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/transitions.jar
```
